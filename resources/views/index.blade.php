...
<body>
    <header>
        ...
        @if (Auth::check())
            ...
            @endif
        {{-- kalau dia belum login, button yg dimunculin button buat ke halaman login --}}
        @else 
    ...
    <section class="baris">
        <div class="kolom kolom1">
            ...
            <ol>
                <li>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Alias modi nemo illum beatae omnis fugit!
                </li>
                <li>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur, debitis?</li>
                <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptate eligendi et atque dolores veniam
                    maiores quasi error deserunt ducimus delectus?</li>
    ...
    <section class="form-container">
        <div class="card form-card">
            ...
            @if (Session::get('success'))
                <div style="width: 100%; backgroud: green; padding: 10px">
                {{ Session::get('success') }}
                </div>
            @endif
